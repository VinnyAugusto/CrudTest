Projeto criado no Visual Studio 2017

Antes de executa-lo, adicione a tabela e os dados (opcional) abaixo no seu banco (SQL SERVER).

*** NAO ESQUEÇA DE ALTERAR A CONNECTIONSTRING NO Web.Config
